...
using MEMO_JOB.Models.JobSeekers.ManageViewModels;
...
namespace MEMO_JOB.Controllers.JobSeekers
{
    ...
    public class ManageJobSeekersController : Controller
    {
        ...
        public ManageJobSeekersController(
          UserManager<ApplicationUser> userManager,
          SignInManager<ApplicationUser> signInManager,
          IEmailSender emailSender,
          ILogger<ManageJobSeekersController> logger,
        ...
        //Hàm sửa thông tin cá nhân seeker
        [HttpPost]
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            if (model.Gender != Gender)
            {
                ...
                if (!setFirstNameResult.Succeeded)
                {
                    throw new ApplicationException($"Unexpected error occurred setting sex for user with ID '{user.Id}'.");
                }
            }
            ...
            if (model.MaritalStatus != MaritalStatus)
            {
                user.MaritalStatus = model.MaritalStatus;
                var setFirstNameResult = await _userManager.UpdateAsync(user);
                if (!setFirstNameResult.Succeeded)
                {
                    throw new ApplicationException($"Unexpected error occurred setting marital status for user with ID '{user.Id}'.");
                }
            }
